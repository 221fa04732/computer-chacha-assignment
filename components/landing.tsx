export default function Landing(){
    return(<div className="w-11/12 bg-neutral-900 flex flex-col justify-center items-start pt-12">
        ...
        <div className="w-full flex gap-[17px] sm:justify-start justify-center">
            <button className="border border-white rounded-full py-[12px] px-[24px]">MY WORKS</button>
